...
int main(int argc, char **argv)
{
    ...
    float **u    = allocFloatMatrix(imax+2, jmax+2);
    float **v    = allocFloatMatrix(imax+2, jmax+2);
    float **p    = allocFloatMatrix(imax+2, jmax+2);
    float **psi  = allocFloatMatrix(imax+2, jmax+2);
    float **zeta = allocFloatMatrix(imax+2, jmax+2);
    char  **flag = allocCharMatrix(imax+2, jmax+2);
...
static void print_help(void)
{
    fprintf(stderr, "%s. Converts mini-cfd output into portable pixmaps.\n\n",
         PACKAGE);
